            ...
            (j = a(document)),
                ...
                (d = N(Object, {
                    ...
                    optionToData: function (a) {
                        return a.is("option")
                            ? { id: a.prop("value"), text: a.text(), element: a.get(), css: a.attr("class"), disabled: a.prop("disabled"), locked: q(a.attr("locked"), "locked") || q(a.data("locked"), !0) }
                            : a.is("optgroup")
                    ...
                    prepareOpts: function (c) {
                        ...
                        if (
                            ...
                            e &&
                                a.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function () {
                                        ...
                                        (g = function (d, e, j) {
                                            ...
                                            for (d = c.sortResults(d, e, f), k = 0, l = d.length; l > k; k += 1)
                                                (m = d[k]),
                                                    ...
                                                    t !== b && r.html(t),
                                                    q.append(r),
                                                    p && ((s = a("<ul></ul>")), s.addClass("select2-result-sub"), g(m.children, s, j + 1), q.append(s)),
                        ...
                        if (
                            (e
                                ...
                                : "query" in c ||
                                  ("ajax" in c
                                      ? ((g = c.element.data("ajax-url")), g && g.length > 0 && (c.ajax.url = g), (c.query = G.call(c.element, c.ajax)))
                                      : "data" in c
                                      ? (c.query = H(c.data))
                                      : "tags" in c &&
                                        ((c.query = I(c.tags)),
                    ...
                    positionDropdown: function () {
                        ...
                        s ? ((u = !0), !p && o && ((v = !0), (u = !1))) : ((u = !1), !o && p && ((v = !0), (u = !0))),
                            ...
                            (w = { left: n, width: e }),
                            u
                                ? ((w.bottom = i - c.top), (w.top = "auto"), this.container.addClass("select2-drop-above"), b.addClass("select2-drop-above"))
                                : ((w.top = m), (w.bottom = "auto"), this.container.removeClass("select2-drop-above"), b.removeClass("select2-drop-above")),
                    ...
                    updateResults: function (c) {
                        ...
                        if ((c === !0 || !k || !q(j, k)) && (a.data(this.container, "select2-last-term", j), c === !0 || (this.showSearchInput !== !1 && this.opened()))) {
                            ...
                            if (d.val().length < f.minimumInputLength)
                                return (
                                    J(f.formatInputTooShort, "formatInputTooShort") ? n("<li class='select2-no-results'>" + f.formatInputTooShort(d.val(), f.minimumInputLength) + "</li>") : n(""),
                                ...
                                f.query({
                                    ...
                                    callback: this.bind(function (g) {
                                        ...
                                        if (l == this.queryCount) {
                                            ...
                                            e.empty(),
                                                h.opts.populateResults.call(this, e, g.results, { term: d.val(), page: this.resultsPage, context: null }),
                                                g.more === !0 &&
                                                    J(f.formatLoadMore, "formatLoadMore") &&
                                                    (e.append("<li class='select2-more-results'>" + h.opts.escapeMarkup(f.formatLoadMore(this.resultsPage)) + "</li>"),
                                                    window.setTimeout(function () {
                                                        h.loadMoreIfNeeded();
                                                    }, 10)),
                    ...
                    getPlaceholder: function () {
                        var a;
                        return (
                            this.opts.element.attr("placeholder") || this.opts.element.attr("data-placeholder") || this.opts.element.data("placeholder") || this.opts.placeholder || ((a = this.getPlaceholderOption()) !== b ? a.text() : b)
                        );
                    },
                    ...
                    clear: function (b) {
                        ...
                        if (c) {
                            ...
                            this.opts.element.val(e ? e.val() : ""),
                                ...
                                this.setPlaceholder(),
                                b !== !1 && (this.opts.element.trigger({ type: "select2-removed", val: this.id(c), choice: c }), this.triggerChange({ removed: c }));
                        }
                    },
                    ...
                    data: function (a) {
                        ...
                        return 0 === arguments.length
                            ...
                            : (arguments.length > 1 && (d = arguments[1]),
                              a ? ((c = this.data()), this.opts.element.val(a ? this.id(a) : ""), this.updateSelection(a), d && this.triggerChange({ added: a, removed: c })) : this.clear(d),
                              void 0);
                    },
                })),
                (f = N(d, {
                    ...
                    selectChoice: function (a) {
                        ...
                        (b.length && a && a[0] == b[0]) ||
                            ...
                            a && a.length && (this.close(), a.addClass("select2-search-choice-focus"), this.opts.element.trigger("choice-selected", a)));
                    },
                    destroy: function () {
                    ...
                    clearSearch: function () {
                        ...
                        a !== b && 0 === this.getVal().length && this.search.hasClass("select2-focused") === !1
                            ? (this.search.val(a).addClass("select2-default"), this.search.width(c > 0 ? c : this.container.css("width")))
                    ...
                    onSelect: function (a, b) {
                        this.triggerSelect(a) &&
                            ...
                            this.opts.closeOnSelect
                                ...
                                ? (this.search.width(10), this.resizeSearch(), this.getMaximumSelectionSize() > 0 && this.val().length >= this.getMaximumSelectionSize() && this.updateResults(!0), this.positionDropdown())
                                : (this.close(), this.search.width(10)),
                    ...
                    unselect: function (b) {
                        ...
                        if ((d = b.data("select2-data"))) {
                            ...
                            (f.val = this.id(d)),
                                ...
                                f.isDefaultPrevented() || (b.remove(), this.opts.element.trigger({ type: "select2-removed", val: this.id(d), choice: d }), this.triggerChange({ removed: d }));
                        }
                    },
                    postprocessResults: function (a, b, c) {
                        var d = this.getVal(),
                        ...
                        this.each(function () {
                            if (0 === c.length || "object" == typeof c[0])
                                (d = 0 === c.length ? {} : a.extend({}, c[0])),
                                    (d.element = a(this)),
                                    "select" === d.element.get(0).tagName.toLowerCase() ? (j = d.element.prop("multiple")) : ((j = d.multiple || !1), "tags" in d && (d.multiple = j = !0)),
                                    (g = j ? new f() : new e()),
                                    g.init(d);
                            else {
                ...
                (window.Select2 = { query: { ajax: G, local: H, tags: I }, util: { debounce: v, markMatch: E, escapeMarkup: F, stripDiacritics: n }, class: { abstract: d, single: e, multi: f } });
        }
    })(jQuery);
